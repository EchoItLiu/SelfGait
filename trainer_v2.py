...
class BYOLTrainer:
    ...
    def train(self, train_dataset,maxiter=10000,do_test=True):
        ...
        for epoch_counter in range(self.max_epochs):
            ...
            for batch_view in train_loader:
                ...
                loss = self.update(batch_view,train_label_set)
    ...
    def update(self, batch_view_1,train_label_set):
        ...
        if(self.niter%10==0):
            ...
            if self.hard_or_full_trip == 'hard':
                loss_ft = hard_loss_metric.mean()
            elif self.hard_or_full_trip == 'full':
                loss_ft = full_loss_metric.mean()
    ...
    def finetune(self, finetune_source,maxiter=50000,do_test=True):
        #train_loader = DataLoader(train_dataset, batch_size=self.batch_size,num_workers=self.num_workers, drop_last=False, shuffle=True)
